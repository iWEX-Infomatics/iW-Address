...
frappe.ui.form.on('Customer Group', {
    ...
    customer_group_name: (frm) => FormHandler.handle(frm, 'customer_group_name', 'custom_customer_group', TextFormatter.full.bind(TextFormatter), TextFormatter.realTime.bind(TextFormatter)),

    before_save(frm) {
        FormHandler.cleanup(frm, ['customer_group_name']);
